...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
    if event.key == pygame.K_RIGHT:
        ...
        sys.exit("You found the secret key! Thanks for playing!")
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    #Start a new game if player hits 'Play' button
...
def get_number_aliens_x(ai_settings, alien_width):
    #Determine number of aliens that fit in a rwo
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Check for bullets that have hit aliens, if so, get rid of the bullet and alien
